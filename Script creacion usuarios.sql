...
CREATE USER 'Usuario2'@'localhost' IDENTIFIED BY 'Lautaro1'; #Se crea el usuario Usuario 2 
GRANT SELECT ON triggers_Lautaro_Ron.* TO 'Usuario2'@'localhost'; #Se le da permiso para poder usar el select y leer todas las tablas de la base de datos

CREATE USER 'Usuario3'@'localhost' IDENTIFIED BY 'Lautaro2'; #Se crea usuario3
GRANT SELECT, INSERT, UPDATE ON triggers_Lautaro_Ron.* TO 'Usuario3'@'localhost'; #se da permiso de lectura, insercios y modificacion de datos.